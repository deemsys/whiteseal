...
downarrowpointer: ["resources/images/onebit_34.png", 0,0], //path to "down arrow" image that gets added to main menu items (last 2 parameters should be width/height of img)
rightarrowpointer: ["resources/images/onebit_34.png", 10,7], //path to "right arrow" image that gets added to LI elements within drop down menu containing additional menus
